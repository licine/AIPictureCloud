...
import com.tutu.constant.UserConstant;
...
import com.tutu.manager.auth.StpKit;
...
import com.tutu.model.vo.PictureTagCategory;
...
//        String redisKey = "tututu:listPictureVOByPage:" + hashKey;
//        // 从 Redis 缓存中查询
...
//        }
        ...
        String queryCondition = JSONUtil.toJsonStr(pictureQueryRequest);
        String hashKey = DigestUtils.md5DigestAsHex(queryCondition.getBytes());
        String cacheKey = "tututu:listPictureVOByPage:" + hashKey;
